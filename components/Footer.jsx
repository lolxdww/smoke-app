...
const Footer = () => {
  return (
    <>
    <footer class="w-full bg-white px-4 py-6 text-black">
    <div
        class="container md:mx-auto lg:mx-auto xl:mx-auto flex flex-col-reverse gap-5 md:flex-row lg:flex-row xl:flex-row items-center justify-between">
        {/* <!-- logo copyright --> */}
        <div class="">
            <p class="text-xs">&copy; 2023 Smoke inc. All rights reserved.</p>
        </div>
        {/* <!-- social links --> */}
        <div class="flex items-center space-x-4">
            <a href="" class="text-gray-950 hover:text-gray-600">
